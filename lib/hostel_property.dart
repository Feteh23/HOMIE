...
class HostelProperty extends StatefulWidget {
  const HostelProperty({Key? key}):super(key: key);

  @override
  State<HostelProperty> createState() => _HostelPropertyState();
}

class _HostelPropertyState extends State<HostelProperty> {
  @override
